...
> WordImmo is a Property management web app that helps people to rent or buy property at any part of the World. We are using Rapid API to list the available houses, With Agents to facilitate the process. 


### Task - Full Stack webstack portfolio project(WordImmo)
...
AUTHORS
* Ishaq lagnaoui **[Github](https://github.com/ishaq2023)**
* Bouchra Hannasi **[Github](https://github.com/BouChrahns99)**
*
